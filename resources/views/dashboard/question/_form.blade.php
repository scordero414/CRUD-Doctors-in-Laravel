        ...
        <div class="form-group">
            <div class="row center">
                <div class="col ">
                    ...
                    <select class="form-control" name="answer5" id="answer5">
        ...
        <div class="form-group">
            <div class="row center">
                <div class="col ">
                    ...
                    <select class="form-control" name="answer6" id="answer6">
        ...
        <div class="form-group">
            <div class="row center">
                <div class="col ">
                    ...
                    <select class="form-control" name="answer7" id="answer7">
        ...
        <div class="form-group">
            <div class="row center">
                <div class="col ">
                    ...
                    <select class="form-control" name="answer8" id="answer8">
        ...
        <div class="form-group">
            <div class="row center">
                <div class="col ">
                    ...
                    <select class="form-control" name="answer10" id="answer10">
